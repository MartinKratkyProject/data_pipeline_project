...
1. Select the purpouse of this project. (What data will I gather...)    |  ETA - 23.2.
2. Find a good source of data (.csv, .excl, url).                       |  ETA - 2.3.
3. Set up airflow/kafka for scheduling ETL/ELT pipelines.               |  ETA - Done
    - set up docker                                                     
        - set up WSL2
